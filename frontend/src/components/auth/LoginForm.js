...
import { FaEnvelope, FaLock, FaWater, FaFish,FaEye, FaEyeSlash } from 'react-icons/fa';
...
const LoginForm = () => {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-ocean-gradient relative overflow-hidden ">
      {/* animate bg elements */}
      ...
      { /* form box */ }
      <motion.div 
        className="bg-white rounded-2xl md:p-10 w-full max-w-md shadow-2xl relative z-10"
      ...
      >
        ...
        <motion.div variants={itemVariants}>
          <h2 className="md:text-3xl font-bold mb-3 bg-gradient-to-r from-ocean-600 to-ocean-400 bg-clip-text text-transparent">
            Login to WaveMinder
          </h2>
          ...
          <motion.div className="mb-6" variants={itemVariants}>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full pl-12 pr-12 py-3.5 border-2 border-ocean-100 rounded-xl text-ocean-700 bg-ocean-50 focus:outline-none focus:border-ocean-400 focus:bg-white focus:shadow-lg focus:shadow-ocean-400/10 transition-all duration-300"
                required
              />
              <button
                type="button"
